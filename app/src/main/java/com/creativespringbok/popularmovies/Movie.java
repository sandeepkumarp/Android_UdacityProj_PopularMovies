...
public class Movie {
    ...
    //constructor
    public Movie(Long id, String title, String poster_path, String overview, Double vote_average, Long vote_count) {
        this.id = id;
        this.title = title;
    ...
    public String toString() {
        ...
        String retString = " itemID: " + id.toString() + " itemTitle: " + title.toString() + " itemPoster: " + poster_path.toString() + " itemSynopsis: " + overview.toString() + " itemRating: " + vote_average.toString() + " vote_count: " + vote_count + "\n";
        return retString;
    }
